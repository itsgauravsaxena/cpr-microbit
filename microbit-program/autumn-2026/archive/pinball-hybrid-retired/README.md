...
!!! warning "Archived — not running in Autumn 2026"
    This was a hybrid micro:bit + 3D-design pinball course. The autumn 2026 term now runs
    two micro:bit-only groups instead ([Beginners](../../microbit-beginners/README.md) and
    [Pro](../../microbit-pro/README.md)). The material is kept here for reference and reuse.
...
## Parts of the machine (naming)

Use these names so everyone means the same thing:
